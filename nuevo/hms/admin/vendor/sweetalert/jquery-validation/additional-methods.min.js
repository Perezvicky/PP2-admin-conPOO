...
!(function (a) {
  ...
  !(function () {
    ...
    a.validator.addMethod(
      ...
      a.validator.format("Por favor escribe {0} palabras o menos.")
    ),
      a.validator.addMethod(
        "minWords",
        function (a, c, d) {
        ...
        a.validator.format("Por favor escribe al menos {0} palabras.")
      ),
      a.validator.addMethod(
        "rangeWords",
        function (a, c, d) {
        ...
        a.validator.format("Por favor escribe entre {0} y {1} palabras.")
      );
  })(),
    a.validator.addMethod(
      "accept",
      ...
      a.validator.format("Por favor escribe un valor con un tipo de minimo válido.")
    ),
    a.validator.addMethod(
      "alphanumeric",
      function (a, b) {
    ...
    a.validator.addMethod(
      ...
      "Especifique un número de cuenta bancaria válido"
    ),
    a.validator.addMethod(
      "bankorgiroaccountNL",
      function (b, c) {
      ...
      "Especifique un número de cuenta bancaria o giro postal válido"
    ),
    a.validator.addMethod(
      "bic",
      function (a, b) {
      ...
      "Especifique un código BIC válido"
    ),
    a.validator.addMethod(
      "cifES",
      function (a) {
    ...
    a.validator.addMethod(
      ...
      a.validator.format("Por favor escribea value with a valid extension.")
    ),
    a.validator.addMethod(
      "giroaccountNL",
      function (a, b) {
    ...
    a.validator.addMethod(
      ...
      a.validator.format("Por favor escribe al menos {0} characters")
    ),
    a.validator.addMethod(
      "time",
      function (a, b) {
